...
namespace AzureManager
{
    public class Startup
    {
        ...
        {
            // Add AuthenticationService with params from appsettings.json
            services.AddScoped<IAuthenticationService>(_ => new AuthenticationService
                (
            ...
            // Add ResourceGroupService
            services.AddScoped<IResourceGroupService, ResourceGroupService>();

            services.AddMvc();

            // Create a class to map AppSettings values
